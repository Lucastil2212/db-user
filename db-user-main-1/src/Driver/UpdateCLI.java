...
public class UpdateCLI {
    ...
    public static void UpdateCLIPassenger(){
        System.out.println("Update Passenger Y/N?? Press enter to skip");
    ...
    public static void UpdateCLILocation(){
        System.out.println("Update Location Y/N?? Press enter to skip");
    ...
    public static void UpdateCLIRoute(){
        System.out.println("Update Route Y/N?? Press enter to skip");
    ...
    public static void UpdateCLIPilot(){
        System.out.println("Update Pilot Y/N?? Press enter to skip");
    ...
    public static void UpdateCLIBooking(){ 
        System.out.println("Update Booking Y/N?? Press enter to skip");
    ...
    public static void UpdateCLIBookingInfo(){
        System.out.println("Update Booking Info Y/N?? Press enter to skip");
    ...
    public static void UpdateCLIStatus(){
        System.out.println("Update Status Y/N?? Press enter to skip");
    ...
    public static void UpdateCLIPlane(){
        System.out.println("Update Plane Y/N?? Press enter to skip");
    ...
    public static void UpdatetCLISchedule(){
        System.out.println("Update Schedule Y/N?? Press enter to skip");
